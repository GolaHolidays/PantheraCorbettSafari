...
export const StickyCallBar: React.FC<StickyCallBarProps> = ({
  ...
  return (
    <aside
      ...
      className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#17211A]/95 backdrop-blur-md border-t border-[#37482E] px-3 py-2.5 shadow-2xl safe-area-pb"
    >
      <div className="max-w-md mx-auto grid grid-cols-2 gap-2.5">
        ...
        <Button
          ...
          size="md"
          href={`tel:${phoneRaw}`}
          className="w-full flex items-center justify-center gap-2 text-sm font-bold shadow-md bg-[#B84C1E] hover:bg-[#8F3B16]"
        >
